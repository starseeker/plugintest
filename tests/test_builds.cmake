...
function(run_config CONFIG_NAME)
    ...
    if(NOT CMAKE_RESULT EQUAL 0)
        ...
        list(APPEND CONFIGS_RESULTS "  ${CONFIG_NAME}: FAIL (cmake)")
        set(CONFIGS_RESULTS "${CONFIGS_RESULTS}" PARENT_SCOPE)
        return()
    endif()
    ...
    if(NOT BUILD_RESULT EQUAL 0)
        ...
        math(EXPR FAILED "${FAILED} + 1")
        set(FAILED ${FAILED} PARENT_SCOPE)
        list(APPEND CONFIGS_RESULTS "  ${CONFIG_NAME}: FAIL (build)")
        set(CONFIGS_RESULTS "${CONFIGS_RESULTS}" PARENT_SCOPE)
        return()
    endif()
    ...
    if(NOT TEST_RESULT EQUAL 0)
        ...
        math(EXPR FAILED "${FAILED} + 1")
        set(FAILED ${FAILED} PARENT_SCOPE)
        list(APPEND CONFIGS_RESULTS "  ${CONFIG_NAME}: FAIL (tests)")
        set(CONFIGS_RESULTS "${CONFIGS_RESULTS}" PARENT_SCOPE)
        return()
    endif()
    ...
    list(APPEND CONFIGS_RESULTS "  ${CONFIG_NAME}: PASS")
    set(CONFIGS_RESULTS "${CONFIGS_RESULTS}" PARENT_SCOPE)
endfunction()
...
foreach(result IN LISTS CONFIGS_RESULTS)
    message("${result}")
endforeach()
message("")
